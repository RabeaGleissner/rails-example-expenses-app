...
class ExpenseReportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create expense_report" do
    assert_difference('ExpenseReport.count') do
      post expense_reports_url, params: { expense_report: { approved: @expense_report.approved, date: @expense_report.date, items: @expense_report.items, title: @expense_report.title } }
    end
  ...
  test "should update expense_report" do
    patch expense_report_url(@expense_report), params: { expense_report: { approved: @expense_report.approved, date: @expense_report.date, items: @expense_report.items, title: @expense_report.title } }
